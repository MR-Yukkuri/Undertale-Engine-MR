...
function MakeBoneWaveHP(x,y,_vspeed,_size=50,_center_space=40,_wave_size=20,_space_cycle=0.3,_wave_offset=0,_use_cos=false,_color=COLOR.WHITE,_head=false,_space=12,_follow=false,_follow_target=battle_board){
