...
///@desc 左から骨の壁を生やします。
function MakeBoneWallLeftP(_length,pause=30,duration=30,_color=COLOR.WHITE,_bone_space=12,_follow=false,_follow_target=battle_board){
	...
	alart.position = [
		[X-_follow_target.left+1,Y-_follow_target.up+1],
		[X-_follow_target.left+_length-2,Y+_follow_target.down-2]
	]
