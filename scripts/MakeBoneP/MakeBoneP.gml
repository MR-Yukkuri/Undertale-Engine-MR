...
///@desc パピルスの骨を作成する。
function MakeBoneP(_x,_y,_length,_angle=0,_hspeed=0,_vspeed=0,_rot=0,_color=COLOR.WHITE,_out=false,_head_type=0,_origin=0,_len=0,_auto_destroy=true,_duration=-1,_sin_size=0,_sin_speed=0.1,_use_cos=false,sin_offset=0,_follow=false,_follow_target=battle_board){
