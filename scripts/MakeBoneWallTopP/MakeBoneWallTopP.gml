...
///@desc 上から骨の壁を生やします。
function MakeBoneWallTopP(_length,pause=30,duration=30,_color=COLOR.WHITE,_bone_space=12,_follow=false,_follow_target=battle_board){
	...
	alart.position = [
		...
		[X+_follow_target.right-2,Y-_follow_target.up+_length-2]
	]
