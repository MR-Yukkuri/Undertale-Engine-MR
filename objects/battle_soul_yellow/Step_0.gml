...
if(Battle_GetState()==BATTLE_STATE.IN_TURN && moveable){
	...
	shot--
	if shot<0 && Input_IsPressed(INPUT.CONFIRM) && instance_number(battle_soul_yellow_bullet) < bullet_max{
		shot = b_inv
		snd_play(snd_shot)
		instance_create_depth(x,y+2,depth,battle_soul_yellow_bullet)
	}
}